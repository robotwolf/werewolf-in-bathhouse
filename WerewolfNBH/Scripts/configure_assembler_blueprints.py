...
ENTRY_PATH = "/Game/WerewolfBH/Blueprints/Rooms/BP_Room_EntryFacadeNight.BP_Room_EntryFacadeNight_C"
...
def main() -> None:
    ...
    if hasattr(unreal, "RoomClassEntry") and has_editor_property(cdo, "RoomClassPool"):
        ...
        smoking_patio_entry.set_editor_property("Weight", 0.9)
        smoking_patio_entry.set_editor_property("MinRoomsBetweenUses", 3)
