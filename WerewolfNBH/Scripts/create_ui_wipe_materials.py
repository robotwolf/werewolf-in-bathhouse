...
def build_iris_material():
    ...
    aspect_ratio = add_expression(material, unreal.MaterialExpressionScalarParameter, -760, 210)
    scaled_r = add_expression(material, unreal.MaterialExpressionMultiply, -540, -170)
    square_r = add_expression(material, unreal.MaterialExpressionMultiply, -320, -170)
    square_g = add_expression(material, unreal.MaterialExpressionMultiply, -540, 10)
    add_len = add_expression(material, unreal.MaterialExpressionAdd, -110, -70)
    sqrt_len = add_expression(material, unreal.MaterialExpressionSquareRoot, 90, -70)

    radius = add_expression(material, unreal.MaterialExpressionScalarParameter, -540, 360)
    softness = add_expression(material, unreal.MaterialExpressionScalarParameter, -540, 500)
    opacity = add_expression(material, unreal.MaterialExpressionScalarParameter, -540, 640)

    subtract_radius = add_expression(material, unreal.MaterialExpressionSubtract, 310, -70)
    divide_softness = add_expression(material, unreal.MaterialExpressionDivide, 540, -70)
    saturate_alpha = add_expression(material, unreal.MaterialExpressionSaturate, 750, -70)
    final_alpha = add_expression(material, unreal.MaterialExpressionMultiply, 980, -70)

    tint = add_expression(material, unreal.MaterialExpressionVectorParameter, 980, 180)
    ...
    unreal.MaterialEditingLibrary.connect_material_expressions(mask_r, "", scaled_r, "A")
    unreal.MaterialEditingLibrary.connect_material_expressions(aspect_ratio, "", scaled_r, "B")
    unreal.MaterialEditingLibrary.connect_material_expressions(scaled_r, "", square_r, "A")
    unreal.MaterialEditingLibrary.connect_material_expressions(scaled_r, "", square_r, "B")
