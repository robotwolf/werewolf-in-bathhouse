...
def main():
    ...
    build_flat_material('M_Assembler_Test_Entry_Floor', unreal.LinearColor(0.16, 0.12, 0.08, 1.0), roughness=0.92, specular=0.12)
    build_flat_material('M_Assembler_Test_Entry_Wall', unreal.LinearColor(0.66, 0.59, 0.47, 1.0), roughness=0.84, specular=0.16)
    build_flat_material('M_Assembler_Test_Locker_Floor', unreal.LinearColor(0.08, 0.12, 0.14, 1.0), roughness=0.93, specular=0.11)
    build_flat_material('M_Assembler_Test_Locker_Wall', unreal.LinearColor(0.45, 0.52, 0.56, 1.0), roughness=0.86, specular=0.18)
    build_flat_material('M_Assembler_Test_Hall_Floor', unreal.LinearColor(0.12, 0.14, 0.12, 1.0), roughness=0.95, specular=0.10)
    build_flat_material('M_Assembler_Test_Hall_Wall', unreal.LinearColor(0.57, 0.55, 0.50, 1.0), roughness=0.88, specular=0.18)
    build_flat_material('M_Assembler_Test_Stair_Floor', unreal.LinearColor(0.10, 0.10, 0.12, 1.0), roughness=0.94, specular=0.12)
    build_flat_material('M_Assembler_Test_Stair_Wall', unreal.LinearColor(0.36, 0.38, 0.42, 1.0), roughness=0.90, specular=0.16)
    build_flat_material('M_Assembler_Test_Stair_Ceiling', unreal.LinearColor(0.46, 0.49, 0.54, 1.0), roughness=0.86, specular=0.16)
    build_flat_material('M_Assembler_Test_Water', unreal.LinearColor(0.08, 0.32, 0.48, 1.0), roughness=0.12, specular=0.65)
    build_flat_material('M_Assembler_Test_Porcelain', unreal.LinearColor(0.82, 0.84, 0.86, 1.0), roughness=0.28, specular=0.46)
    build_flat_material('M_Assembler_Test_ServiceMetal', unreal.LinearColor(0.34, 0.36, 0.39, 1.0), roughness=0.42, specular=0.52, metallic=0.65)
    build_flat_material('M_Assembler_Test_WoodBench', unreal.LinearColor(0.38, 0.25, 0.14, 1.0), roughness=0.72, specular=0.18)
