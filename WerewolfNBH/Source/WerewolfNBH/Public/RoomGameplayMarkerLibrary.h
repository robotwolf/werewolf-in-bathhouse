...
public:
    UFUNCTION(BlueprintCallable, Category="Room|Gameplay", meta=(AutoCreateRefTerm="RequiredRoomTags,BlockedRoomTags,RequiredActivityTags,BlockedActivityTags"))
    ...
    UFUNCTION(BlueprintCallable, Category="Room|Gameplay", meta=(AutoCreateRefTerm="RequiredTags,BlockedTags"))
    ...
    UFUNCTION(BlueprintCallable, Category="Room|Gameplay", meta=(AutoCreateRefTerm="RequiredRoomTags,BlockedRoomTags,RequiredActivityTags,BlockedActivityTags,RequiredMarkerTags,BlockedMarkerTags"))
    ...
    UFUNCTION(BlueprintCallable, Category="Room|Gameplay", meta=(AutoCreateRefTerm="RequiredRoomTags,BlockedRoomTags,PreferredRoomTags,RequiredActivityTags,BlockedActivityTags,PreferredActivityTags,RequiredMarkerTags,BlockedMarkerTags,PreferredMarkerTags"))
    ...
    UFUNCTION(BlueprintCallable, Category="Room|Gameplay", meta=(WorldContext="WorldContextObject"))
